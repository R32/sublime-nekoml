...
NML_STD = {
	"list": [
		("iter('a->void, 'a list):void", "iter(${1:fn}, ${2:l})$0"),
		("mem('k, 'k list):bool", "mem(${1:key}, ${2:l})$0"),
		("map('a->'b, 'a list):'b list", "map(${1:fn}, ${2:l})$0"),
		("fold('b->'a->'b, 'b, 'a list):'b", "fold(${1:fn}, ${2:init} ,${3:l})$0"),
		("length('a list):int", "length(${1:l})$0"),
		("hd('a list):'a", "hd(${1:l})$0"),
		("tl('a list):'a list", "tl(${1:l})$0"),
		("iter2('a->'b->void, 'a list, 'b list):void\t throw", "iter2(${1:fn}, ${2:list1}, ${3:list2})$0"),
		("split(('a,'b)list):('a list, 'b list)", "split(${1:tplist})$0"),
		("exists('k->bool, 'k list):bool", "exists(${1:fn}, ${2:l})$0"),
		("assoc('k, ('k,'v) list):'v\t == throw Not_found", "assoc(${1:fn}, ${2:tplist})$0"),
		("phys('k, ('k,'v) list):'v\t === throw Not_found", "phys(${1:fn}, ${2:tplist})$0"),
		("find('k->bool,'k list):'k\t throw Not_found", "find(${1:fn}, ${2:l})$0"),
		("rev('a list):'a list", "rev(${1:l})$0"),
		("append('a list, 'a list):'a list", "append(${1:src}, ${2:dst})$0"),
		("concat('a list list):'a list", "concat(${1:listlist})$0"),
		("chop(int, 'a list):'a list\t throw arg", "chop(${1:begin}, ${2:l})$0"),
		("all('a->bool, 'a list):bool", "all(${1:fn}, ${2:l})$0"),
		("none('a->bool, 'a list):bool", "none(${1:fn}, ${2:l})$0"),
		("nth('a list, int):'a:\t throw arg", "nth(${1:l}, ${2:pos})$0"),
		("filter('a->bool, 'a list):'a list", "filter(${1:fn}, ${2:l})$0"),
		("array('a list):'a array", "array(${1:l})$0"),
		("sort('a->'a->bool,'a list):'a list", "sort(${1:comp}, ${2:l})$0"),
	],
	...
	"array": [
		("string('a array):string", "string(${1:a})$0"),
		("length('a array):int", "length(${1:a})$0"),
		("create():'a array", "create()$0"),
		("add(a: 'a array, x:'a):void", "add(${1:a}, ${2:x})$0"),
		("get(a: 'a array, p:int):'a", "get(${1:a}, ${2:pos})$0"),
		("set(a: 'a array, p:int, x:'a):void", "set(${1:a}, ${2:pos}, ${3:x})$0"),
		("make(size: int, x: 'a):'a array", "make(${1:len}, ${2:init})$0"),
		("init(size: int, f: int -> 'a):'a array", "init(${1:len}, ${2:fn})$0"),
		("iter(f: 'a -> void, a:'a array):void", "iter(${1:fn}, ${2:a})$0"),
		("iteri(f: int -> 'a -> void, a: 'a array):void", "iteri(${1:fn}, ${2:a})$0"),
		("map(f: 'a -> 'b, a: 'a array):'b array", "map(${1:fn}, ${2:a})$0"),
		("sort(f: 'a -> 'a -> int, a:'a array):void", "sort(${1:comp}, ${2:a})$0"),
		("list(a:'a array):'a list", "list(${1:a})$0"),
		("append(src: 'a -> array, dst:'a array):void", "append(${1:src}, ${2:dst})$0"),
		("sub(a: 'a array, p: int, l: int):'a array", "sub(${1:a}, ${2:pos},${3:len})$0"),
		("blit(dst: 'a array, pdst:int, src: 'a array, psrc: int l: int):void", "blit(${1:dst}, ${2:pdst}, ${3:src}, ${4:psrc} ${5:len})$0"),
		("index(a:'a array, it: 'a):int", "index(${1:a}, ${2:x})$0"),
	],
	...
	"set": [
		...
		("empty(): 'a Set", "empty()$0"),
		("iter(f: 'a -> void, set: 'a Set): 'a Set", "iter(${1:fn}, ${2:set})$0"),
